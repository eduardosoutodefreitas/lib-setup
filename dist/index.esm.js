...
const Button = ({ children, variant = "primary", size = "large", type = "button", disabled, loading, className, ...props }) => {
    return (jsxs(Fragment, { children: [loading && jsx("div", { className: styles$6.loading_overlay, children: " " }), jsx("button", { type: type, disabled: loading || disabled, className: [
                    styles$6.button,
