...
import { useRef, useState, useCallback, useEffect, useMemo, Children, cloneElement, forwardRef } from 'react';
...
function Badge({ children, variant = "gray", size = "sm", disabled, className, ...props }) {
    return (jsx("button", { disabled: disabled, className: [
            styles$6.button,
            size ? sizes[size] : "",
...
const Button = ({ children, variant = "primary", size = "large", type = "button", disabled, loading, className, ...props }) => {
    return (jsxs(Fragment, { children: [loading && jsx("div", { className: styles$5.loading_overlay, children: " " }), jsx("button", { type: type, disabled: loading || disabled, className: [
                    styles$5.button,
...
const Container = ({ children, className }) => {
    ...
    if (isEmpty)
        return null;
    console.log(isOpen);
    return (jsxs("div", { className: containerStyles, children: [triggerChild &&
...
const Divider = () => {
    return jsx("div", { className: styles$3.divider });
};
...
const Item = ({ className, ...props }) => {
    ...
    return jsx("button", { className: itemStyles, ...props });
};
...
const Menu = forwardRef(({ children, className, ...props }, ref) => {
    return (jsx("div", { ref: ref, className: concatStyles([styles$1.menu, className]), ...props, children: children }));
});
Menu.displayName = "Menu";

var styles = {"wrapper":"test_wrapper_srnv7","isOpen":"test_isOpen_srnv7"};

const Trigger = forwardRef(({ children, isOpen, ...props }, ref) => {
    if (typeof children === "function") {
        return children(props, ref);
    }
    return (jsx("button", { ref: ref, className: concatStyles([styles.wrapper, isOpen ? styles.isOpen : ""]), ...props, children: children }));
});
...
export { Badge, Button, Dropdown, global as GlobalStyles };
